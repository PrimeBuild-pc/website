import{L as e,N as t,S as n}from"./index-Y-z0Loq7.js";import{t as r}from"./proxy-BvWMFZfa.js";import{r as i,t as a}from"./guideHeadingCase-szb5EvLR.js";var o=e(t(),1),s=`Ecco un report tecnico dettagliato e aggiornato al 2026 sulla gestione dei modelli di presentazione (Presentation Models) in Windows 11 e su come configurare al meglio il tuo sistema per ottenere la latenza minima su hardware moderno.
...
`,c=n(),l=e=>i.sanitize(e,{USE_PROFILES:{html:!0}}),u=`w-full rounded-xl border border-zinc-800 my-8 shadow-lg object-contain`,d=[{src:`/images/guides/MPO.webp`,alt:`Schema Multi-Plane Overlay`},{src:`/images/guides/HAGS.webp`,alt:`Schema Hardware Accelerated GPU Scheduling`},{src:`/images/guides/VRR.webp`,alt:`Schema Variable Refresh Rate`}],f=e=>e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/\"/g,`&quot;`).replace(/'/g,`&#39;`),p=e=>{let t=f(e);return t=t.replace(/(https?:\/\/[^\s<]+)/g,`<a href="$1" target="_blank" rel="noopener noreferrer">$1</a>`),t=t.replace(/\*\*([^*]+)\*\*/g,`<strong>$1</strong>`),t=t.replace(/(^|[^*])\*([^*]+)\*/g,`$1<em>$2</em>`),t},m=e=>e.length>0&&e.every(e=>/^\*\s+/.test(e.trim())),h=e=>e.length>0&&e.every(e=>/^\d+\.\s+/.test(e.trim())),g=()=>s.replace(/\r\n/g,`
...
`).map(e=>e.trimEnd());return m(t)?{type:`ul`,items:t.map(e=>e.replace(/^\*\s+/,``).trim())}:h(t)?{type:`ol`,items:t.map(e=>e.replace(/^\d+\.\s+/,``).trim())}:{type:`p`,content:e}}),_=()=>{let e=(0,o.useMemo)(()=>g(),[]),t=(0,o.useMemo)(()=>e.length<6?[1]:Array.from(new Set([Math.max(1,Math.floor(e.length*.25)),Math.max(2,Math.floor(e.length*.55)),Math.max(3,Math.floor(e.length*.8))])).filter(t=>t>0&&t<e.length),[e]);return(0,c.jsxs)(`div`,{className:`space-y-4`,children:[(0,c.jsx)(r.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{duration:.3,delay:.28},children:(0,c.jsx)(`img`,{src:`/images/guides/presentation-models-1.jpg`,alt:`Modelli di presentazione tecnologici`,className:u})}),e.map((e,n)=>(0,c.jsxs)(`div`,{children:[(0,c.jsx)(r.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{duration:.3,delay:.35+n*.03},className:`[&_p]:text-zinc-300 [&_p]:leading-relaxed [&_p]:mb-6 [&_h2]:text-white [&_h2]:font-bold [&_h2]:text-2xl [&_h2]:mt-12 [&_h2]:mb-6 [&_h2]:border-b [&_h2]:border-zinc-800 [&_h2]:pb-2 [&_h3]:text-xl [&_h3]:text-zinc-100 [&_h3]:mt-8 [&_h3]:mb-4 [&_h4]:text-lg [&_h4]:text-primary [&_h4]:mt-6 [&_h4]:mb-3 [&_strong]:text-primary [&_strong]:font-semibold [&_em]:text-zinc-100 [&_ul]:list-disc [&_ul]:list-inside [&_ul]:mb-6 [&_ul]:space-y-2 [&_ol]:list-decimal [&_ol]:list-inside [&_ol]:mb-6 [&_ol]:space-y-2 [&_li]:text-zinc-300 [&_li]:leading-relaxed [&_li]:marker:text-primary [&_a]:text-primary [&_a]:underline-offset-2 [&_a:hover]:text-primary`,children:e.type===`h2`?(0,c.jsx)(`h2`,{dangerouslySetInnerHTML:{__html:l(p(e.content))}}):e.type===`ul`?(0,c.jsx)(`ul`,{children:e.items.map((e,t)=>(0,c.jsx)(`li`,{dangerouslySetInnerHTML:{__html:l(p(e))}},`presentation-ul-${n}-${t}`))}):e.type===`ol`?(0,c.jsx)(`ol`,{children:e.items.map((e,t)=>(0,c.jsx)(`li`,{dangerouslySetInnerHTML:{__html:l(p(e))}},`presentation-ol-${n}-${t}`))}):e.type===`hr`?(0,c.jsx)(`hr`,{className:`border-white/10 my-6`}):(0,c.jsx)(`p`,{className:`whitespace-pre-line`,dangerouslySetInnerHTML:{__html:l(p(e.content))}})},`presentation-block-${n}`),t.includes(n+1)?(0,c.jsx)(r.div,{initial:{opacity:0,y:10},animate:{opacity:1,y:0},transition:{duration:.3,delay:.38+n*.03},className:`w-full`,children:(0,c.jsx)(`img`,{src:d[Math.min(t.indexOf(n+1),d.length-1)]?.src,alt:d[Math.min(t.indexOf(n+1),d.length-1)]?.alt??`Schema tecnico`,className:u})}):null]},`presentation-block-wrapper-${n}`))]})};export{_ as default};